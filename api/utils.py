...
def send_indiening_confirmation_mail(indiening):
    ...
    receiver = "test-7lnkcgnm7@srv1.mail-tester.com"
    ...
    for student in indiening.groep.studenten.all():
        ...
        <p>Dit is een bevestiging dat uw indiening voor <a href="{project_url}">{project.titel}</a> is ontvangen.</p>
        ...
        email["To"] = receiver#student.user.email
        ...
        with smtplib.SMTP_SSL(smtp_server_address, smtp_port, context=context) as smtp_server:
            ...
            smtp_server.sendmail(mail_username, receiver, email.as_string())
