...
export default function InputFileUpload({name, fileTypes, path, onFileChange, tooltip}: InputFileUploadProps) {
    const clearFile = () => {
    ...
    return (
        <>
            <Box aria-label={'upload_button'} padding={1} display={'flex'} flexDirection={'column'}
                ...
                <Box aria-label={'filename'} padding={0} display={'flex'} flexDirection={'row'}
                     alignItems={'center'}
