...
export function RestrictionCard({restriction, restrictions, setRestrictions}: RestrictionCardProps) {
    ...
    return (
        <>
            <Box display={'flex'} flexDirection={'row'} width={'100%'} justifyContent={'space-between'}>
                <Typography variant={'body2'}>{restriction.script.replace(/^.*[\\/]/, '')}</Typography>
