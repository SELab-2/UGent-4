/*
    This file is used to configure the Auth0 SDK.
    We need to provide the domain and client ID of our Auth0 application.
    The validation of the token is already implemented in the backend.
    That's why we need to send the token to the backend with every request using our Axios configuration.
 */
